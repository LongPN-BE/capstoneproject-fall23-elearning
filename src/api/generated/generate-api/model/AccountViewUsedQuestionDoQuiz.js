 ...
 * @module model/AccountViewUsedQuestionDoQuiz
 * @version v1
 */
class AccountViewUsedQuestionDoQuiz {
    /**
     * Constructs a new <code>AccountViewUsedQuestionDoQuiz</code>.
     * @alias module:model/AccountViewUsedQuestionDoQuiz
     */
    constructor() { 
        
        AccountViewUsedQuestionDoQuiz.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AccountViewUsedQuestionDoQuiz</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AccountViewUsedQuestionDoQuiz} obj Optional instance to populate.
     * @return {module:model/AccountViewUsedQuestionDoQuiz} The populated <code>AccountViewUsedQuestionDoQuiz</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AccountViewUsedQuestionDoQuiz();
    ...
    /**
     * Validates the JSON data with respect to <code>AccountViewUsedQuestionDoQuiz</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AccountViewUsedQuestionDoQuiz</code>.
     */
    static validateJSON(data) {
        ...
        if (data['authorities']) { // data not null
            ...
            for (const item of data['authorities']) {
                GrantedAuthorityViewUsedQuestionDoQuiz.validateJsonObject(item);
            };
        }
 ...
 */
AccountViewUsedQuestionDoQuiz.prototype['createdAt'] = undefined;

/**
 * @member {Date} updatedAt
 */
AccountViewUsedQuestionDoQuiz.prototype['updatedAt'] = undefined;

/**
 * @member {Date} deletedAt
 */
AccountViewUsedQuestionDoQuiz.prototype['deletedAt'] = undefined;

/**
 * @member {String} password
 */
AccountViewUsedQuestionDoQuiz.prototype['password'] = undefined;

/**
 * @member {module:model/AccountViewUsedQuestionDoQuiz.RoleEnum} role
 */
AccountViewUsedQuestionDoQuiz.prototype['role'] = undefined;
 ...
 */
AccountViewUsedQuestionDoQuiz.prototype['accountNonExpired'] = undefined;

/**
 * @member {Boolean} credentialsNonExpired
 */
AccountViewUsedQuestionDoQuiz.prototype['credentialsNonExpired'] = undefined;
 ...
 */
AccountViewUsedQuestionDoQuiz.prototype['enabled'] = undefined;
 ...
 * @readonly
 */
AccountViewUsedQuestionDoQuiz['RoleEnum'] = {
...
export default AccountViewUsedQuestionDoQuiz;
