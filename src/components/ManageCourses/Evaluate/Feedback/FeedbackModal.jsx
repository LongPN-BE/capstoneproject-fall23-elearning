            ...
            <Dialog open={open} onClose={onClose}>
                ...
                <DialogContent>
                    <Paper style={{ padding: '20px', width: '30rem', margin: '0 auto' }}>
                        {data.feedbackDetails && data.feedbackDetails.map((question, index) => {
                            if (question?.type === 'text') {
                                return (
                                    ...
                                    // />
                                    <div dangerouslySetInnerHTML={{ __html: question?.text }} style={{ border: '2px solid black', padding: '1rem', marginBottom: '20px' }}></div>
                                )
                            } else {
                                return (
