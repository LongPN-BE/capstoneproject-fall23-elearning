        ...
        <div style={{ margin: '20px' }}>
          <Paper style={{ padding: '20px' }}>
            <Typography variant="body1">
              ...
              {'>'} <Link to={`/courses/${courseId}/syllabus/${syllabusId}`}>Khung chương trình {syllabusId} </Link>{'>'} <Link to={`/courses/${courseId}/syllabus/${syllabusId}/lessons/${lessonId}`}> Bài học {lessonId} </Link> {'>'} Tạo quiz
            </Typography>
