...
import { isInRange, isInteger, validateInputDigits, validateInputString, isInRangeDynamic } from '../../../util/Utilities';
        ...
        <Dialog open={open} onClose={onClose} aria-labelledby="form-dialog-title">
            ...
            <DialogContent>
                ...
                <div className='d-flex justify-content-between'>
                    ...
                    <TextField className='col-6 mx-1' label="Giá ( VND )" value={newPrice} onChange={(e) => setNewPrice(e.target.value)} sx={{ my: 1 }} type='number' />
                </div>
                <div className='d-flex justify-content-between'>
                ...
                <TextField className='mt-3' fullWidth label="Mô tả" value={newDescription} onChange={(e) => {
