...
const ListSubject = () => {
    ...
    useEffect(() => {
        ...
        const filteredData = subjectData.filter(subject =>
            subject.accounts && subject.accounts.some(account => account.id == user?.id)
        );
                        ...
                        <TableBody>
                            {sortedData.map((subject) => (
                                <TableRow key={subject.id}>
                                    ...
                                    <TableCell>{subject.status ? "Active" : "Inactive"}</TableCell>
                                    <TableCell>
                                        <Link to={`/subjects/${subject.id}/courses`} className='buttonLink'>
                                            Q.lý khóa học
                                        </Link>
                                    </TableCell>
                                </TableRow>
