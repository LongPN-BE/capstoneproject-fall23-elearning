  ...
  return (
    data && (
      <div className="px-5 py-3" style={{ overflow: 'auto', height: 850 }}>
        <div className="mb-3">
          <h4 style={{ fontWeight: 'bold' }}>Lịch sử thanh toán</h4>
          ...
          <Table style={{ marginTop: '20px' }}>
            <TableHead style={{ backgroundColor: '#f4f6f8' }}>
              <TableRow>
                ...
                <TableCell></TableCell>
                <TableCell style={{ color: '#808d99', fontWeight: 700 }}>Phương thức</TableCell>
                <TableCell>
                  <Typography style={{ color: '#808d99', fontWeight: 700 }}>Số tiền</Typography>
                  <Typography variant="caption">VNĐ</Typography>
                </TableCell>
                <TableCell style={{ color: '#808d99', fontWeight: 700 }}>Loại giao dịch</TableCell>
                <TableCell style={{ color: '#808d99', fontWeight: 700 }}>Tài khoản thực hiện</TableCell>
                ...
                .map((s, index) => {
                  return (
                    <TableRow hover={true} key={index}>
                      ...
                      <TableCell>
                        <Typography style={{ fontWeight: 600, color: '#686f77' }} variant="body1">
                          {moment(s.transactionDate).format('DD-MM-YYYY')}
                        </Typography>
                      </TableCell>
                      <TableCell>
                        <Typography style={{ fontWeight: 600, color: '#686f77' }} variant="body1">
                          {moment(s.transactionDate).format('hh:mm A')}
                        </Typography>
                      </TableCell>
                      <TableCell style={{ fontWeight: 600, color: '#686f77', textTransform: 'uppercase' }}>
                        {s.paymentMethod}
                      </TableCell>
                      <TableCell style={{ fontWeight: 600, color: '#686f77' }}>
                        {' '}
                        {s.paymentHistoryType === 'WITHDRAW' ? (
                          <>
                            <Typography variant="subtitle1" style={{ fontWeight: 'bold', color: '#df4842' }}>
                      ...
                      <TableCell style={{ fontWeight: 600, color: '#686f77' }}>
                        ...
                        {s.student === null ? (
                          ...
                          <Typography variant="caption">(HỌC SINH)</Typography>
                        )}
                      </TableCell>
                      <TableCell>
                        {s.paymentHistoryStatus === 'CREATED' ? (
                          ...
                          >
                            <Typography style={{ fontWeight: 'bold', color: '#328cb2' }}>Đã tạo</Typography>
                          </div>
                          ...
                          >
                            <Typography style={{ fontWeight: 'bold', color: '#2a9a68' }}>Nạp thành công</Typography>
                          </div>
                          ...
                          >
                            <Typography style={{ fontWeight: 'bold', color: '#c64843' }}>Hoàn tiền</Typography>
                          </div>
                          ...
                          >
                            <Typography style={{ fontWeight: 'bold', color: '#ffab00' }}>Đang xử lý</Typography>
                          </div>
                          ...
                          >
                            <Typography style={{ fontWeight: 'bold', color: '#2a9a68' }}>Rút thành công</Typography>
                          </div>
