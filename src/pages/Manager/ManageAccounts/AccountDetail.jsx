...
import { Dialog, DialogActions, DialogContent, Button, DialogTitle, Typography, Avatar, Grid, Divider } from '@material-ui/core';
        ...
        <Dialog open={isOpen} onClose={onClose} maxWidth="sm" fullWidth>
            ...
            <DialogContent dividers>
                <Grid container spacing={2}>
                    <Grid item xs={2}>
                        <Avatar style={{ height: '55px', width: '55px' }} alt={editedAccount.avatar} src="##" />
                    </Grid>
                    <Grid item xs={6}>
                        <Typography variant='h6' style={{ mt: '-30px' }} >{editedAccount.lastName} {editedAccount.firstName}</Typography>
            ...
            <DialogContent dividers>
                ...
                <Typography variant='inherit'> {editedAccount.lastName} {editedAccount.firstName}</Typography> <br />
                <Divider />
                ...
                <Typography variant='inherit'>{editedAccount.address}</Typography><br />
            </DialogContent>
            <DialogActions>
